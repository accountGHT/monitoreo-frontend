...
const columnsWithoutActions = [
  ...
  { field: 'hora_llamada', headerName: 'Hora Llamada', flex: 1, minWidth: 100, maxWidth: 100, renderCell: (params) => params.row.hora },
  ...
  { field: 'descripcion_llamada', headerName: 'Desc. llamada', flex: 1, minWidth: 200, maxWidth: 300 },
  {
...
const CommunicationsCenterList = ({ selectedStatus, data, onEdit, onDelete, onCancel, onDespachar, onConfirmar, onVer }) => {
  ...
  return (
    <div style={{ height: 500, width: '100%' }}>
      ...
      >
        {selectedRow && selectedRow.estado == 'abierto' && (
        ...
        <MenuItem onClick={handleVerDetalle}>Ver detalle</MenuItem>
