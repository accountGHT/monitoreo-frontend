...
import { fnFormatTime } from 'utils/date-and-time';
...
const columnsWithoutActions = [
    ...
    { field: 'hora', headerName: 'Hora', flex: 1, minWidth: 120, maxWidth: 140, renderCell: (params) => fnFormatTime(params.row.hora) },
    ...
    {
        field: 'patrullero', headerName: 'Patrullero', flex: 2, minWidth: 100, maxWidth: 160,
        renderCell: (params) => {
            return params.row.patrullero.nombres;
        }
    },
    ...
    {
        field: 'patrullaje_integrado', headerName: 'PATRULLAJE MUNICIPAL O INTEGRADO', flex: 1.5, minWidth: 130, maxWidth: 180,
