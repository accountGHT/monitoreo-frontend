...
const columnsWithoutActions = [
  ...
  { field: 'name', headerName: 'Nombre', flex: 1, minWidth: 175, maxWidth: 300 },
  { field: 'email', headerName: 'Email', flex: 1, minWidth: 250, maxWidth: 300 },
  { field: 'email_verified_at', headerName: 'Email verificado en', flex: 1, minWidth: 175, maxWidth: 300 },
  { field: 'created_at', headerName: 'Fecha de creación', flex: 1, minWidth: 175, maxWidth: 300 },
  { field: 'updated_at', headerName: 'Última actualización', flex: 1, minWidth: 175, maxWidth: 300 },
];
...
const UsersList = ({ data, onEdit, onDelete }) => {
